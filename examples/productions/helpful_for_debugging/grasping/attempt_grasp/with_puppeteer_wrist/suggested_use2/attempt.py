...
def create_block_m_sdf(
    path_to_block_m_stl: Path, scaling_factor: float = 0.003, model_mass: float = 2e-3
) -> Path:
    """
    *Description*
    ...
    obj_file_name = path_to_block_m_stl.parent / path_to_block_m_stl.name.replace(
        ".stl", ".obj"
    )
...
def main(scaling_factor: float = 3e-3):
    ...
    *Description*
    ...
    block_m_stl = (
        ...
        / "models/michigan_block_m/University_of_Michigan_M.stl"
    )
