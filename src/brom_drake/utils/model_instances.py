...
def get_name_of_all_bodies_in_urdf(urdf_in: str) -> list[str]:
    ...
    *Description*
    ...
    try:
        ...
        raise RuntimeError(f"Failed to parse the urdf file: {urdf_in}.") from e
    ...
    if len(model_instances) > 1:
        ...
        raise RuntimeWarning(f"No model instance found in the urdf file: {urdf_in}.")
