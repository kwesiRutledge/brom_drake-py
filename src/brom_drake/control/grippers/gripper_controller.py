...
class GripperController(LeafSystem):
    ...
    *Parameters*
    ...
    def __init__(
        self, gripper_type: GripperType, Kp: np.ndarray = None, Kd: np.ndarray = None
    ):
        """
        *Description*
        ...
        *Parameters*
        ...
        if self.type == "hande":
            ...
            raise NotImplementedError(
                "Gripper type %s does not have CalcGripperPosition() implemented"
                % self.type
            )
    ...
    def CalcGripperVelocity(self, context, output):
        ...
        *Parameters*
        ...
        if self.type == "hande":
            ...
            raise NotImplementedError(
                "Gripper type %s does not have CalcGripperVelocity() implemented"
                % self.type
            )
    ...
    def ComputePosition(self, state: np.ndarray) -> np.ndarray:
        ...
        *Returns*
        ...
        if self.type == GripperType.Robotiq_2f_85:
            ...
            raise NotImplementedError(
                "Gripper type %s does not have ComputePosition() implemented"
                % self.type
            )
    ...
    def ComputeVelocity(self, state: np.ndarray) -> np.ndarray:
        ...
        **Returns**
        ...
        if self.type == GripperType.Robotiq_2f_85:
            ...
            raise NotImplementedError(
                "Gripper type %s does not have ComputeVelocity() implemented"
                % self.type
            )
        ...
        *Parameters*
        ...
        if Kp is not None:
            ...
            if self.type == GripperType.Robotiq_2f_85:
                ...
                raise NotImplementedError(
                    "Gripper type %s does not have Kp initialized" % self.type
                )
        ...
        if Kd is not None:
            ...
            if self.type == GripperType.Robotiq_2f_85:
                ...
                raise NotImplementedError(
                    "Gripper type %s does not have Kd initialized" % self.type
                )
    ...
    def gripper_width(self) -> float:
        ...
        *Returns*
        ...
        if self.type == GripperType.Robotiq_2f_85:
            ...
            raise NotImplementedError(
                "Gripper type %s does not have gripper_width implemented" % self.type
            )
