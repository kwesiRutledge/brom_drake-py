...
class Script:
    ...
    **Assumptions**
    ...
    time_outs: List[
        float
    ]  # The amount of time given for the robot to reach each of the targets
    ...
    def to_networkx_graph(self) -> nx.DiGraph:
        ...
        for ii, target_name_ii in enumerate(target_names):
            ...
            assert (
                target_ii.model_instance_index is not None
            ...
            for phase_jj in pick_and_place_phases:
                graph.add_node(
                    ...
                    outputs=[
                        FSMOutputDefinition(
                            f"model_target", target_ii.model_instance_index
                        ),
                    ],
                )
